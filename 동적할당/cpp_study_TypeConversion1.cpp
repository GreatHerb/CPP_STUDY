...
// malloc -> void *을 변환하고, 이를 우리가 [타입 변환]을 통해 사용했었음
...
int main()
{
    ...
    // 타입이 다르거나
    // 같은 타입이지만 큰 바구니 -> 작은 바구니로 이동 (다운캐스팅) -> 데이터 손실이 일어날 수 있다
    {
        int a = 123456789;
        float b = a;
        short c = a;
